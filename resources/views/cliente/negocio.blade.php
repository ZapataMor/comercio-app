            ...
            @foreach ($items as $p)
                <div class="flex items-center justify-between p-4 gap-3">
                    ...
                    <div class="flex items-center gap-3 shrink-0">
                        ...
                        {{-- El botón de pedir llegará con el flujo de pedidos --}}
                        <button class="text-sm bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg px-3 py-1.5" disabled
                                title="Disponible cuando construyamos los pedidos">
                            Pedir
                        </button>
                    </div>
                </div>
