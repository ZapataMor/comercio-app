...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña proporcionada se ha filtrado en una fuga de datos. Elige una contraseña diferente.',
    ],
    ...
    /*
     | Mensajes personalizados por atributo+regla (opcional).
     */
    'custom' => [
        'password' => [
    ...
    /*
     | Nombres legibles de los campos (reemplazan a :attribute).
     */
    'attributes' => [
        'name' => 'nombre',
        'nombre' => 'nombre',
        ...
        'minutos_recogida' => 'minutos de recogida',
        'cantidad' => 'cantidad',
    ],
